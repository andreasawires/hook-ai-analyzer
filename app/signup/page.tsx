        ...
        <Card className="w-full max-w-md border-2 border-indigo-100 dark:border-indigo-900 hover:shadow-xl transition-all duration-300">
          <CardHeader className="space-y-2 text-center">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Create an account to start analyzing your hooks
            </p>
          </CardHeader>
          <CardContent>
            {error && (
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              <div className="space-y-2">
                <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-indigo-600 dark:text-indigo-400" htmlFor="name">
                  Name
                </label>
                <Input
                  id="name"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-indigo-600 dark:text-indigo-400" htmlFor="confirmPassword">
                  Confirm Password
                </label>
                <Input
                  id="confirmPassword"
